...
export function GalleryDetailPage() {
  ...
  if (isError || !gallery) {
    return (
      <div className="container mx-auto px-4 py-24 text-center lg:px-8">
        ...
        <BackButton to="/galeri" label="Kembali ke Galeri" variant="gradient" className="mt-6" />
      </div>
    )
  }
  ...
  return (
    <PublicPageShell backTo="/galeri" backLabel="Kembali ke Galeri" title={title} description={gallery.description ? String(gallery.description) : title}>
